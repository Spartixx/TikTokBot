...
try:   
    db = MC.connect(host = '141.94.185.10', database = 's5_tiktokdb', user = 'u5_m4llKHq3bx', password= '!jFw3aiEcixNhze4y@lyWNu@')
    mycursor = db.cursor()
    ...
    mycursor.execute(f"SELECT content FROM posts WHERE id = {lst}")
...
if (__name__ == "__main__"):
 ...
 / __|_ __  __ _ _ _| |_(_)_ __ \ \ / (_)_____ __ _| _ ) ___| |_ 
 \__ \ '_ \/ _` | '_|  _| \ \ /  \ V /| / -_) V  V / _ \/ _ \  _|
 |___/ .__/\__,_|_|  \__|_/_\_\   \_/ |_\___|\_/\_/|___/\___/\__|
     |_|   
